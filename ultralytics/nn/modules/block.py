...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3', 'stem', 'MBConvBlock', 'BiFPN_Add2', 'BiFPN_Add3',
           'ScConv')
...
class MBConvBlock(nn.Module):
    def __init__(self, inp, final_oup, k, s, expand_ratio, drop_connect_rate, has_se=False):
        ...
        if self.has_se:
            ...
            self.se = SeBlock(oup, 4)   # 改,将SE改成SCConv
...
class BiFPN_Add2(nn.Module):
    ...
    def forward(self, x):
        ...
        # print(self.conv(self.silu(weight[0] * x[0] + weight[1] * x[1])).shape)
