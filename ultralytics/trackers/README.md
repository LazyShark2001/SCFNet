...
model = YOLO("path/to/SCFNet.pt")  # Load a custom trained model
...
yolo track model=path/to/SCFNet.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained model

# Track using ByteTrack tracker
yolo track model=path/to/SCFNet.pt tracker="bytetrack.yaml"
```
